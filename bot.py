...
import time 
 ...
 server = [["<host>", "<SSH Port>", "<user>", "<user_password>"]] 
 ...
     embed = discord.Embed(title="Info : ", description="Powered by Oxida") 
 ...
     embed = discord.Embed(title="Status of attack server : ", description="Powered by Oxida") 
